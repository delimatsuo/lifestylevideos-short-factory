...
def main():
    ...
    try:
        ...
        # STEP 3: Process all approved content through complete pipeline
        ...
        for content in approved_content:
            ...
            try:
                ...
                if script:
                    ...
                    sheets.update_content_field(content_id, 'script', script)
                else:
                ...
                audio_file = audio_gen.generate_audio_for_content(content)
                if audio_file:
                    print("✅ Audio generated")
                    # Update spreadsheet with audio file path
                    sheets.update_content_field(content_id, 'audio_file', audio_file)
                else:
                ...
                video_result = video_sourcing.source_videos_for_content(content)
                if video_result:
                ...
                assembly_result = video_assembly.assemble_video_for_content(content)
                if assembly_result:
                ...
                caption_result = caption_mgr.generate_captions_for_content(content)
                if caption_result:
                ...
                metadata_result = metadata_mgr.generate_metadata_for_content(content)
                if metadata_result:
                ...
                # Mark as completed
                sheets.update_content_status(content_id, 'Completed')
                videos_produced += 1
